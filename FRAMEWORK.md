...
- **001 - Solution-Z** → [[plans/goals/001-solution-z.md]]
  基于 Obsidian 行动管理系统的可视化孪生应用（Vue + Electron + SQLite）
- **002 - 3D 建筑可视化** → [[plans/goals/002-architecture-viz.md]]
  基于 Three.js 的建筑复原交互网页（暂缓，等 Solution-Z 稳定后再展开）
