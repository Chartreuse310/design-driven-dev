...
> ⚠️ **已归档** — 这套体系将被纳入更完整的知识库中，因此不会被继续维护。

---

> 从设计出发，学习全栈技术，探索从设计到落地的可能性。

**[→ 访问站点](https://design-driven-dev.vercel.app)**

## 这是什么

我是一名喜欢折腾的设计师，希望能通过学习实现从设计到落地的全栈开发流程，当一个发明大王！这个仓库记录了我从零开始的学习过程——包括我的小目标、小思考和小成就（但愿有吧）。
